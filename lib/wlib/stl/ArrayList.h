...
namespace wlp {
    ...
    public:
        ...
        /**
         * Constructor from an array index rvalue
         * and a backing array list.
         *
         * @param i array index rvalue
         * @param list backing array list
         */
    ...
    public:
         ...
         * @return iterator to the inserted element
         */
        const_iterator insert(const_iterator &it, const val_type &t) {
            ensure_capacity();
            shift_right(it.m_i);
            m_data[it.m_i] = t;
            ++m_size;
         ...
         * @return iterator to the inserted element
         */
        const_iterator insert(const_iterator &it, val_type &&t) {
            ensure_capacity();
            shift_right(it.m_i);
            m_data[it.m_i] = t;
            ++m_size;
